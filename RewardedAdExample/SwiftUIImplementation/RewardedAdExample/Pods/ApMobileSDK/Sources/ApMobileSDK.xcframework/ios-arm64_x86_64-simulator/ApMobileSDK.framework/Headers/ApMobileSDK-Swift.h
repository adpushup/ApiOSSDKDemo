...
/// @param apAdPlacementId [String]                           Ap Placement ID
/// @param apInterstitialListener [ApInterstitialListener]    Used to listen callbacks from the Ad.
...
/// Ads will be shown only at the right time.
/// @param apAdPlacementId [String]                   Ap Placement ID
/// @param apRewardedListener [ApRewardedListener]    Used to listen callbacks from the Ad.
...
/// @param apAdPlacementId [String] Ap Placement ID
/// @return True if the ad is ready else False
+ (BOOL)isRewardedAdReadyWithApPlacementID:(NSString * _Nonnull)apPlacementID SWIFT_WARN_UNUSED_RESULT;
/// Resume the SDK after App Activity Resumes. SDK might preload ads if required. Call this method in
/// [Activity.onResume] method to ensure the SDK is ready to show ads when your app resumes.
+ (void)resume;
